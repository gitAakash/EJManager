$(document).ready(function () {
    ...
    $("#btn_Submit").click(function () {
        ...
        var statusEventsModel = [];
        $("#statusEventsTable tr").each(function (i, item) {
            ...
            if (i > 0) {
                ...
                statusEventsModel.push(curRow);
            }
        })


        statusEventsModel = JSON.stringify({ 'statusEventsModel': statusEventsModel });

        $.ajax({
            url: '/TriggerConfiguration/UpdateStatusEvents',
            type: 'POST',
            data: statusEventsModel,
            dataType: 'json',
